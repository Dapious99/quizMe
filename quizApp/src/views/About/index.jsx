...
const AboutUs = () => {
  return (
    <div className="bg-gray-200 h-screen px-16 md:px-5 sm:px-3">
      <div className="font-sans flex flex-col gap-5 text-lg py-3">
        <p>Welcome to quizMe, where learning meets fun!</p>
        <p>
          At quizMe, we believe that education should be engaging, interactive,
          and accessible to everyone. That's why we've created a unique platform
          that combines the thrill of quizzes with the richness of history,
        ...
        <p>
          ...
          knowledge, quizMe has something for everyone.
        </p>
        <p>
        ...
        <p>
          But quizMe is more than just a quiz app; it's a journey through time,
          a portal to the past, and a window into the wonders of history. With
          rich content, engaging visuals, and user-friendly features, we strive
      ...
      <div className="flex flex-col items-center">
        <div className="shadow-lg rounded-md bg-white text-center text-blue-600 p-3">
          ...
          <p>Frontend Developer & Lead Developer</p>
        </div>
      </div>
    </div>
  );
